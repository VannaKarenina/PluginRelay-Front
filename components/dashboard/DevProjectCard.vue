...
<template>
  <div class="tw-flex tw-flex-col tw-w-550 tw-h-145 tw-items-center tw-bg-white tw-border tw-border-gray-200 tw-rounded-md tw-shadow md:tw-flex-row hover:tw-bg-gray-100 dark:tw-border-gray-700 dark:tw-bg-gray-800 dark:hover:tw-bg-gray-700">
    <img class="tw-m-2 tw-rounded-lg tw-w-222" :src="getImage(project.favicon_path)" />
